...
TRANSLATIONS = {
    'pt': {
        ...
        'end_time_must_be_after_start_time': 'O horário de término deve ser depois do horário de início.',
        ...
        'high_time_suggestion': 'Sugestão de Ajuste de Tempo',
        'consider_balancing_time_in': 'Considere equilibrar melhor seu tempo em:',
        'consider_reducing_time_in': 'Considere reduzir o tempo em:',
    ...
    'en': {
        ...
        'high_time_warning': 'Areas with Too Much Time',
        'high_time_suggestion': 'Time Adjustment Suggestion',
        'consider_balancing_time_in': 'Consider balancing your time better in:',
        'consider_reducing_time_in': 'Consider reducing time in:',
